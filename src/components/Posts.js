...
import Bearth from "./images/b_earth.png"
    ...
    return (
        <div className="posts">
            <div className="post-container">
                <h1 className="category-header">PORTFOLIO</h1>
                <p className="category-introduction">The below is a list of selected work. The aim of this list is to show growth and development over time, as well as future potential.</p>
                    ...
                    <li className="post-item">
                        <div className="post-item-wrapper">
                            <PostItem
                                alt="B.Earth Logo"
                                src={Bearth}
                                header="B.earth Website"
                                text="This is a prototype for a website which was developed 
                                during the course of Prototyping and Interaction Design in the 
                                autumn of 2020. The website prototype was an integral part of a 
                                larger exam assignment. The intention was to showcase a fictional 
                                company selling a physical product, which was also prototyped. 
                                As the main driving force, I was responsible for both the digital
                                and the physical prototypes."
                            />
                            <div className="button-wrap">
                                <Button
                                    path="https://xd.adobe.com/view/46ca5fac-add4-4749-845c-f0955145e312-1399/?fullscreen"
                                    title="View Project"
                                />
                            </div>
                        </div>
